      ...
      <div className="content-grid">
        ...
        <div className="about-wrapper">
          <div className="about-content" style={{ color: textPrimary }}>
            ...
            <ul>
              <li>Client Side -
                <span> <a href="https://www.w3schools.com/html/" target="blank">HTML</a>, <a href="https://www.w3schools.com/Css/" target="blank">CSS</a>, <a href="https://sass-lang.com/" target="blank">SCSS</a>, <a href="http://lesscss.org/" target="blank">LESS</a>, <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="blank">Javascript</a>, <a href="https://reactjs.org/" target="blank">React</a>, <a href="https://redux.js.org/" target="blank">Redux</a>, <a href="https://reacttraining.com/react-router/l" target="blank">React Router</a></span>
              </li>
              <li>Server Side -
                <span> <a href="http://expressjs.com/" target="blank">Express</a>, <a href="https://nodejs.org/en/" target="blank">Node</a>, <a href="http://mongoosejs.com/" target="blank">Mongoose</a>, <a href="https://www.mongodb.com/" target="blank">Mongo</a>, <a href="http://docs.sequelizejs.com/" target="blank">Sequelize</a>, <a href="https://www.python.org/" target="blank">Python</a>, <a href="https://www.djangoproject.com/" target="blank">Django</a>, <a href="https://www.sqlite.org/index.html" target="blank">SQLite</a>, <a href="http://www.django-rest-framework.org/" target="blank">Django REST Framework</a>, <a href="https://graphql.org/" target="blank">GraphQL</a> - <a href="https://www.howtographql.com/" target="blank">Tutorial</a></span>
              </li>
              <li>Testing -
